...
parser = argparse.ArgumentParser(description='gen42')
...
DIM = 128*4
A_COL = 96#must be the multiple of 1, 4 for maxpooling, most 128
...
for k in range(0, A_COL):
  ...
  for t in range(0, 128):
    I_file = I_file + str(twos_complement(A[t][k], 4))
